  ...
  <div class="content-part">
    <div class="content-left">
      ...
      <div class="btn-submit-save">
        <div>
          <el-button :disabled="doing" @click="onSubmit('roleform')" native-type="submit"
                     style="width: 100px;margin-bottom: 10px" type="primary">保存
          </el-button>
        </div>
        <div>
          <el-button @click.prevent.stop="doClose" style="width: 100px">关闭</el-button>
        </div>
      </div>
    </div>
    <div class="content-right min-gutter">
      <h3></h3>
      <el-form :model="form" :rules="rules" @submit.prevent="onSubmit('roleform')" label-width="100px"
               onsubmit="return false" ref="roleform">
        <el-form-item label="角色名称" prop="title">
          <oms-input placeholder="请输入" type="text" v-model="form.title"></oms-input>
        </el-form-item>
        <el-form-item label="英文名称" prop="name">
          <oms-input placeholder="请输入" type="text" v-model="form.name"></oms-input>
        </el-form-item>
        <el-form-item label="角色描述">
          <oms-input placeholder="请输入" type="text" v-model="form.remark"></oms-input>
        </el-form-item>
        ...
        <el-scrollbar class="dialog-template-role_scroll" tag="div">
          <div class="check-all">
            <el-checkbox @change="checkAll()" label="全选"
                         v-model="checkAllRoles"></el-checkbox>
          </div>
          <el-tree :data="tree" :default-checked-keys="checkedIdList" :filter-node-method="filterNode"
                   :props="defaultProps" default-expand-all highlight-current
