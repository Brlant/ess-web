      ...
      <div class="d-table-left">
        <h2 class="header">
          <span class="pull-right">
               ...
               <el-tooltip v-has="'ccs-dict-group-export'" content="导出excel" placement="bottom">
                   <a class="btn-circle" href="#" @click.stop.prevent="exportDict">
                  <i class="el-icon-t-export"></i>
                </a>
               </el-tooltip>

                <a v-has="'ccs-dict-group-add'" class="btn-circle" href="#" @click.stop.prevent="addType">
                  <i class="el-icon-t-plus"></i>
                </a>
                <a v-has="'ccs-dict-group-query'" class="btn-circle" href="#" @click.prevent="searchType">
              ...
              <ul class="show-list">
                <li v-for="item in showTypeList" :class="{'active':item.id==currentItem.id}" class="list-item"
                  ...
                  <span class="hover-show">
                      <span v-has="'ccs-dict-group-softDelete'">
                        <a class="pull-right " href="#" @click.prevent="removeType(item)">
                        <i class="el-icon-t-delete"></i>
                        </a>
                      </span>
                      <span v-has="'ccs-dict-group-update'">
        ...
        <el-scrollbar :style="'height:'+bodyHeight" class="d-table-left_scroll" tag="div">
          <div class="scrollbar-content">
            <span class="pull-right" style="padding-top: 10px;padding-right: 10px">
                <span v-has="'ccs-dict-item-query'">
            ...
            <table class="table table-hover">
              ...
              <tr v-for="row in dataRows" :class="{'active':row.id==currentRowItem.id}" @click="showRowItem(row)">
                ...
                <td>
                    <a v-has="'ccs-dict-item-update'" href="#" @click.stop.prevent="edit(row)">
                      <i class="el-icon-t-edit"></i> 编辑
                    </a>

                    <a v-has="'ccs-dict-item-softDelete'" href="#" @click.prevent="remove(row)">
