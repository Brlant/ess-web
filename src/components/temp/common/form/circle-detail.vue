            ...
            <div v-else>
                <div class="form-header-part">
                    ...
                    <div class="content">
                        ...
                        <oms-col :isShow="true" :rowSpan="span" label="产品分类">{{ formItem.typeProduct }}</oms-col>
                        <oms-col :isShow="true" :rowSpan="span" label="是否有视频">{{ formItem.isVideo =='0'? '否':'是' }}</oms-col>
                        <oms-col :isShow="true" :rowSpan="span" label="视频地址">{{ formItem.videoUrl }}</oms-col>
                ...
                <div class="form-header-part">
                    ...
                    <div class="content">
                        <change-record :formItem="formItem" :index="currentIndex"
                                       :statusType="statusType"></change-record>
                    </div>
                </div>
            </div>
        </template>
