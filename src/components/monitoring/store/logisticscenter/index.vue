  ...
  <div class="order-page">
    <el-row class="second-part">
      <el-col :span="11" class="store-dropdown">
        ...
        <el-dropdown @command="menuClick" trigger="click" v-if="logisticsCenterList.length">
          ...
          <el-dropdown-menu class="el-dropdown-menu-width" slot="dropdown">
            ...
            <el-dropdown-item @click="add" class="text-center" command="add" divided v-has="'ccs-logistics-center-add'">
              添加物流中心
            </el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      ...
      <el-col :span="13" class="text-right">
        <des-btn @click="add" icon="plus" v-has="'ccs-logistics-center-add'" v-show="!logisticsCenterList.length">添加物流中心
        </des-btn>
        <span v-if="logisticsCenterList.length">
            <des-btn @click="edit" icon="edit" v-has="'ccs-logistics-center-edit'">编辑物流中心</des-btn>
            <des-btn @click="addWareHouse" icon="plus" v-has="'ccs-warehouse-add'">添加仓库</des-btn>
        </span>
      </el-col>
    </el-row>
  </div>
