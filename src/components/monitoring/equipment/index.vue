<template>
  <div class="order-page">
    ...
    <page-right :css="{'width':'900px','padding':0}" :show="showIndex !== -1" @right-close="resetRightBox">
      <component :formItem="form" :index="showIndex" ref="rightReference" :is="currentPart" @change="change" @right-close="resetRightBox"/>
    </page-right>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            resetRightBox() {
                this.$refs.rightReference && this.$refs.rightReference.resetRightBox && this.$refs.rightReference.resetRightBox() ;
                this.showIndex = -1;
                this.queryList(1);
            ...
            edit(item) {
                ...
                // yxh 修改 : 原来的组件是和添加共用一个组件现在需要拆分出来添加点位信息
                // this.showPart(0);
                this.showPart(2);
            },
            deleteItem(item) {
