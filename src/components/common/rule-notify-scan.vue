...
<template>
  <el-form :model="form" :rules="rules" label-width="100px" ref="form">
    <des-btn @click="isShowRule = true" class="el-form__btn" icon="plus" v-has="perm">添加</des-btn>
    <div class="add-info-part" v-show="isShowRule">
      ...
      <el-form-item label="通知列表" prop="ccsNotifyListId">
        <el-select :remote-method="queryNotifyList" @click.once.native="queryNotifyList('')" clearable
