...
<template>
  <el-dialog :before-close="close" :class="{'docview':type=='doc','img-view':type=='image'}"
             class="attachment-dialog"
             top="0" v-model="dialogVisible">
    <div class="attachment-dialog-head" slot="title">
    ...
    <transition name="el-fade-in">
      <div @click.stop="closeDialog" style="height:100%;width:100%;">
        <div class="dialog-image-rap" v-if="type=='image'">
          <img :src="fileUrl" :style="'transform: rotate('+currentZ+'deg)'"
               @click.stop="stop" alt=''>
        </div>
        <div @click.stop="stop" class="img-tools" v-if="type=='image'">

          <el-button @click.stop="changeZ(1)" type="default"><i class="el-icon-t-rotate"></i>
          </el-button>

        </div>
        <div @click.stop="stop" class="attachment-doc-body" v-if="type=='doc'">
