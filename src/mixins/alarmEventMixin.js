const type = {
    ...
    // 之前逻辑
    // 6: {title: '[点位监控]', path: '/monitoring/temp'}
    6: {title: '[点位监控]', path: '/monitoring/point-dev/temp'} // 数据查询 路由
};
const devPath = {
            ...
            switch (item.monitorRelationType) {
                ...
                case '3' : {
                    params.query = {
                        ...
                        code: item.monitorTargetId, // 点位id 
                        orgId: item.orgId  // 货主id 
                        // code: item.devCode,
                ...
                case '6': {
                    params.query = {
                        // 之前字段
                        // id: item.ccsDevId,
                        pointId : item.monitorTargetId, // 添加点位id 
                        type: '1'
                    };
                    break;
                }
